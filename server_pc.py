...
def startPrediction(file_path):
    ...
    if feature is not None:
        ...
        # check_anomaly(age_prediction,gender_prediction,emotion_prediction)

        print(
            f"Emotion Prediction: {emotion_prediction[0]}, Gender Prediction: {gender_prediction[0]}, Age Prediction: {age_prediction[0]}, Timestamp: {current_time}")  # Debug print
        return jsonify({"emotion_prediction": emotion_prediction[0], "gender_prediction": gender_prediction[0],
                        "age_prediction": age_prediction[0], "timestamp": current_time})
    else:
